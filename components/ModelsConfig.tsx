...
function ModelDetail({
  ...
  const catalogResultSummary = (() => {
    ...
    const price = recommendation.price.method === "cherry"
      ? t("models.catalogPriceCherry")
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ padding: "10px 0", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          ...
          <a
            href="https://github.com/CherryHQ/cherry-studio/tree/main/packages/provider-registry"
            target="_blank"
            rel="noreferrer"
