...
test("does not swallow trailing CJK text into a GFM autolink", () => {
  const html = renderMarkdown(
    "看 https://github.com/x121381/pi-code-desktop/issues/48，然后来解决一下",
  );

  assert.match(
    html,
    /<a [^>]*href="https:\/\/github\.com\/x121381\/pi-code-desktop\/issues\/48"[^>]*>https:\/\/github\.com\/x121381\/pi-code-desktop\/issues\/48<\/a>，然后来解决一下/,
  );
});
