...
const serverHelperDir = join(rootDir, "src-tauri", "resources", "Pi Code Server.app");
...
async function findOverlongPaths() {
  ...
  const windowsPrefix = "D:\\a\\pi-code-desktop\\pi-code-desktop\\src-tauri\\resources\\server";
  const overlong = [];
...
async function bundleNodeRuntime() {
  ...
  if (process.platform === "darwin") {
    ...
    // Info.plist uses the parent CFBundleIdentifier (com.x121381.pi-code) so
